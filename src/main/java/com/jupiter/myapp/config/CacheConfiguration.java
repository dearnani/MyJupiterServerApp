package com.jupiter.myapp.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("MyJupiterServerApp");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("MyJupiterServerApp");
        ...
        config.getMapConfigs().put("com.jupiter.myapp.domain.*", initializeDomainMapConfig(jHipsterProperties));
